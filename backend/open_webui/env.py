...
AIOHTTP_CLIENT_READ_BUFFER_SIZE = os.environ.get('AIOHTTP_CLIENT_READ_BUFFER_SIZE', '16777216')
try:
    AIOHTTP_CLIENT_READ_BUFFER_SIZE = int(AIOHTTP_CLIENT_READ_BUFFER_SIZE)
    if AIOHTTP_CLIENT_READ_BUFFER_SIZE <= 0:
        AIOHTTP_CLIENT_READ_BUFFER_SIZE = 16777216
except Exception:
    AIOHTTP_CLIENT_READ_BUFFER_SIZE = 16777216
